package dev.gaphunter.ssrfallowlistbypasscompanion.review
...
object ReviewPrompt {
    ...
    private const val KEY_SEEN_FINDINGS = "dev.gaphunter.ssrfallowlistbypasscompanion.review.seenFindings"
    private const val KEY_ANSWERED = "dev.gaphunter.ssrfallowlistbypasscompanion.review.answered"

    private const val NOTIFICATION_GROUP_ID = "SSRF Allow-List Bypass Companion"

    // Marketplace listing (real ID resolved after first publish).
    private const val MARKETPLACE_URL = "https://plugins.jetbrains.com/plugin/34082-ssrf-allow-list-bypass-companion/reviews"
